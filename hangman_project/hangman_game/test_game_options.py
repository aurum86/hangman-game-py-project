...
class GameOptionsTest(TestCase):
    ...
    def test_get_word_length_min(self, expected_word_length, assumed_difficulty_level) -> None:
    ...
    def test_get_word_length_max(self, expected_word_length, assumed_difficulty_level) -> None:
        _game_options = GameOptions(difficulty_level=assumed_difficulty_level)
